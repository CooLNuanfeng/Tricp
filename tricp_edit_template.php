        ...
        <div class="editMain">
                ...
                <dl class="t_lineList">
                    <dd>
                        ...
                        <div class="writeTxtBox">
                            ...
                            <div class="textareaDiv"><textarea></textarea></div>
            ...
            <div class="t_listBox">
                ...
                <dl class="t_lineList">
                	<dt>
                    	<h6>第1天</h6>
                        <input type="text" value="2014-07-26">
                        <i class="icon icon_calendarLittle"></i>
                        <div class="iconBig iconDay">D1</div>
                    </dt>
                    <dd>
                        <i class="icon icon_wrPoint"></i>
                        <div class="writeTxtBox">
                            <div class="writeTitle"><span>旅行随笔</span></div>
                            <div class="textareaDiv"><textarea></textarea></div>
                            <i class="icon icon_leftArrow"></i>
                    ...
                    <dd>
                        ...
                        <div class="writeTxtBox">
                            <div class="writeTitle">
                            	<span>这是哪里？</span><a href="javascript:;" class="modifyTitle"><i class="icon icon_modifyTitle"></i>修改</a>
...
随笔</a>
                    ...
                    <dd>
                        ...
                        <div class="writeTxtBox">
                            <div class="writeTitle">
                            	<span>西湖</span><a href="javascript:;" class="modifyTitle"><i class="icon icon_modifyTitle"></i>修改</a>
                                <div class="remainTxt">已输入<span>0</span><em>/500</em>字</div>
                                <a href="javascript:;" class="uploadPics">上传照片</a>
                            </div>
...
随笔</a>
                ...
                <div class="newPoint">新增拍摄点<a href="javascript:;" target="_self" class="icon icon_addPoint"></a></div>
                <dl class="t_lineList">
                	<dt>
                    	<h6>第1天</h6>
                        <input type="text" value="2014-07-26">
...
<div class="t_dialog w730">
	<div class="t_dialog_border">
        ...
        <div class="t_tabAddPoint">
        	<a href="javascript:;" class="active"><i class="iconBig icon_views"></i>景点</a>
            <a href="javascript:;"><i class="iconBig icon_hotels"></i>酒店</a>
            <a href="javascript:;"><i class="iconBig icon_caterings"></i>餐饮</a>
            <a href="javascript:;"><i class="iconBig icon_traffics"></i>交通</a>
            <a href="javascript:;"><i class="iconBig icon_shoppings"></i>购物</a>
            <a href="javascript:;"><i class="iconBig icon_recreations"></i>娱乐</a>
            <a href="javascript:;"><i class="iconBig icon_others"></i>其他</a>
        </div>
