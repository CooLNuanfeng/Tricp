	...
	<div class="t_main t_mainbox">
    	<div class="createInfo pt70">
            ...
            <div class="createInput">
            	...
            	<input type="text" id='input_name' class="input_name"  value="【我是驴神】">
...
<div class="t_dialog">
	<div class="t_dialog_border">
    	<div class="tab_t_booking clearfix">
        	<span class="active">2014年订单</span>
            <span>2013年订单</span>
        </div>
...
<script src="statics/js/tricp.js"></script>
<script>
//日历部分 
calendar(); 
function calendar(){ 
